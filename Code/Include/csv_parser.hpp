 ...
 */
#define define _CRT_SECURE_NO_DEPRECATE
 ...
 *
 * The csv_parser::init() method can accept a character array as the trimmedPath to the CSV file.
...
public :
	 ...
	 * Initializes the current object
	 *
	 * @li This init method accepts a character array as the trimmedPath to the csv file.
